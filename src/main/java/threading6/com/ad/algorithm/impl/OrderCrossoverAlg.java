...
import threading6.com.ad.model.Randomizer;
import threading6.com.ad.algorithm.travellingSalesmanAlgorithm;
...
public class OrderCrossoverAlg implements travellingSalesmanAlgorithm,Runnable {
    ...
    public OrderCrossoverAlg(int vertexCounter, int size, int firstVertex, List<List<Integer>> connections, ThreadsOptimalizator thopt) {
        this.population=population;
        this.firstVertex=firstVertex;
        verticesSize = size;
        this.connectionTable=connections;
